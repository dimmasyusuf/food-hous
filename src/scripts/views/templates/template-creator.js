    ...
    <div id="customerReview" class="customer-review" tabindex="0">
      ...
      <div class="customer-review__item" tabindex="0">
        <div class="customer-review__image-container">
          <picture>
            <source media="(max-width: 600px)" data-srcset="./images/customer-review-small.jpg">
            <img
              class="customer-review__image lazyload"
              data-src="./images/customer-review-large.jpg"
              alt="customer review"
              tabindex="0"
            />
          </picture>
    ...
    <div class="restaurant-info">
      ...
      <div class="restaurant-meta">
        <div class="restaurant-rating" tabindex="0">
          <i class="fa fa-star restaurant-rating__icon" alt="rating icon"></i>
          <span class="restaurant-rating__score">${restaurant.rating}</span>
        </div>
        <div class="restaurant-location" tabindex="0">
          <i class="fa fa-location-dot restaurant-location__icon" alt="location icon"></i>
          <span class="restaurant-location__address">${restaurant.city}</span>
        </div>
      </div>
